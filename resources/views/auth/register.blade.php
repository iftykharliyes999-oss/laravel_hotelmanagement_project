...
<html lang="en">
            ...
            <div class="section-authentication-cover">
                <div class="">
                    <div class="row g-0">
                        ...
                        >
                            <div
                                class="card rounded-0 m-3 shadow-none bg-transparent mb-0"
                            >
    ...
    <div class="input-group">
        ...
        >
                                                ...
                                                <div class="col-12">
                                                    <div class="text-center">
                                                        <p class="mb-0">
                                                            ...
                                                            account?
                                                            <a
                                                                href="{{asset('')}}auth-cover-signin.html"
                                                                >Sign in here</a
                                                            >
                                                        </p>
                                                    </div>
                                        ...
                                        <div
                                            class="login-separater text-center mb-5"
                                        >
                                            <span>OR SIGN UP WITH EMAIL</span>
                                            <hr />
                                        </div>
                                        <div
                                            class="list-inline contacts-social text-center"
                                        >
                                            <a
                                                href="{{asset('')}}javascript:;"
